...
<%
	...
	List<ReaderInfo> list=reader.getList(keyword);
%>
...
var pageData=[];  
    ...
    '<td><%=info.getReaderPassword() %></td>'+  
    '<td><%=info.getReaderEmail() %></td>'+  
    '<td>'+
	'<a href="../reader/reader-delete.jsp?readerid=<%=info.getId() %>">封禁该读者ID</a>'+'&nbsp;&nbsp;'+
	'|<a href="">标为VIP读者</a>'+
	'</td>'
	+'</tr>';  
    pageData.push(data);   
